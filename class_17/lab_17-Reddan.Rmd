...
The mean is `r paste(round(mean(vax.sd_pop$percent_of_population_fully_vaccinated)*100, 2), "%", sep = "")`.  
...
```{r}
avg_vax_rate <- mean(vax.sd_pop$percent_of_population_fully_vaccinated)
